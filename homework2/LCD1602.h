#include<reg52.h>
sbit LCD1602_RS =P1^0; //P1^2;	//位定义，液晶的数据/命令选择
sbit LCD1602_RW = P1^1;//P1^1;	//位定义，液晶的读写选择
sbit LCD1602_EN = P1^2;//P1^0;	//位定义，液晶使能信号

//#define LCDPORT P0	  //液晶的数据口

//unsigned char code ucForum[]=" bbs.cepark.com ";	  //在CODE区定义一个用于显示的常量字符串

void Delay_lcd(unsigned int uiCount);	//延时函数
